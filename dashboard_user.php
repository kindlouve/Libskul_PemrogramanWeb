...
<head>
  ...
  <title>Libskul - Dashboard Siswa</title>
...
<body class="bg-gradient-to-br from-gray-100 to-gray-300 min-h-screen">
  <nav class="bg-white shadow-md p-4">
    <div class="container mx-auto flex justify-between items-center">
      ...
      <div class="space-x-4">
        ...
        <a href="backend/auth/logout.php" class="text-gray-700 hover:text-red-600 font-medium transition">Logout</a>
      </div>
    </div>
  </nav>
  ...
  <section class="container mx-auto flex flex-col items-center justify-center p-8 mt-12">
    <div class="flex flex-col items-center bg-white rounded-xl shadow-lg p-10 max-w-xl w-full">
      ...
      <h2 class="text-4xl font-bold mb-4 text-gray-800 text-center">Selamat Datang di libskul, <span class="text-gray-600"><?= htmlspecialchars($nama_siswa) ?></span>!</h2>
      <p class="text-gray-600 mb-8 text-center">Selamat datang di Libskul, platform peminjaman buku modern untuk siswa sekolah. Temukan dan pinjam buku favoritmu dengan mudah!</p>
